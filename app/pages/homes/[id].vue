			...
			<div class="max-w-screen-xl mx-auto px-4 py-8 space-y-8">
				...
				<div class="grid lg:grid-cols-3 gap-8">
					<div class="lg:col-span-2 space-y-8">
						...
						<section v-else class="aspect-video rounded-3xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
						...
						<div v-if="hasContent" class="space-y-6">
							...
							<section v-if="home.mustKnows?.length" class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
								<div class="flex items-center gap-3 mb-4">
						...
						<div v-else class="text-center py-16 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
							<UIcon name="i-lucide-file-text" class="w-12 h-12 mx-auto text-gray-300 mb-4" />
							...
							<div class="p-6 space-y-6">
								<div v-if="home.wifiPassword" class="flex items-center gap-4">
									<div class="p-3 rounded-xl bg-gray-100 dark:bg-gray-700">
										<UIcon name="i-lucide-wifi" class="w-6 h-6 text-gray-600 dark:text-gray-300" />
									</div>
									<div>
								...
								<div v-if="home.parkingNumber" class="flex items-center gap-4">
									<div class="p-3 rounded-xl bg-gray-100 dark:bg-gray-700">
										<UIcon name="i-lucide-car" class="w-6 h-6 text-gray-600 dark:text-gray-300" />
									</div>
									<div>
