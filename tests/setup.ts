...
const translations: Record<string, string> = {
	...
	"admin.memoriam.kicker": "Gedenken",
	"admin.memoriam.title": "In Memoriam",
	"admin.memoriam.lead": "Gedenkartikel zu verstorbenen Eigentümerinnen und Eigentümern der Résidence.",
	"admin.memoriam.create": "Neuer Eintrag",
	"admin.memoriam.edit": "Bearbeiten",
	"admin.memoriam.delete": "Löschen",
	"admin.memoriam.save": "Speichern",
	"admin.memoriam.cancel": "Abbrechen",
	"admin.memoriam.empty": "Noch keine Einträge",
	"admin.memoriam.emptyHint": "Legen Sie den ersten Gedenkartikel an.",
	"admin.memoriam.name": "Name",
	"admin.memoriam.namePlaceholder": "Vor- und Nachname",
	"admin.memoriam.bio": "Lauftext",
	"admin.memoriam.bioHint": "Nur auf Deutsch erfassen. Beim Speichern wird automatisch ins Französische übersetzt.",
	"admin.memoriam.period": "Zeitraum in der Résidence",
	"admin.memoriam.periodFrom": "Von",
	"admin.memoriam.periodTo": "Bis",
	"admin.memoriam.periodHint": "Jahr (1990) oder Datum (1990-06-15).",
	"admin.memoriam.moveUp": "Nach oben",
	"admin.memoriam.moveDown": "Nach unten",
	"admin.memoriam.orderHint": "Reihenfolge mit den Pfeilen ändern.",
	"admin.memoriam.photos": "Fotos",
	"admin.memoriam.addPhotos": "Fotos hinzufügen",
	"admin.memoriam.confirmDelete": "Diesen Eintrag wirklich löschen?",
	"admin.memoriam.toasts.loadFailed": "Einträge konnten nicht geladen werden",
	"admin.memoriam.toasts.nameRequired": "Bitte einen Namen angeben",
	"admin.memoriam.toasts.saved": "Eintrag gespeichert",
	"admin.memoriam.toasts.created": "Eintrag erstellt",
	"admin.memoriam.toasts.deleted": "Eintrag gelöscht",
	"memoriam.title": "In Memoriam",
	"memoriam.subtitle": "Zum Gedenken",
	"memoriam.emptyTitle": "Noch keine Einträge",
	"memoriam.emptyText": "Gedenkartikel erscheinen hier, sobald sie erfasst sind.",
	"memoriam.periodLabel": "In der Résidence",
	"memoriam.manage": "Einträge verwalten",
	"memoriam.openImage": "Bild vergrössern",
	"memoriam.closeImage": "Bild schliessen",
	"memoriam.previousImage": "Vorheriges Bild",
	"memoriam.nextImage": "Nächstes Bild",
